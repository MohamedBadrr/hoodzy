...
export default function NewsletterSignup() {
  return (
    <section className="my-10 absolute left-1/2 top-0 w-[calc(100%-2rem)] max-w-310 -translate-x-1/2 -translate-y-1/2 rounded-[20px] bg-black px-5 py-7 text-white sm:w-[calc(100%-4rem)] sm:px-8 sm:py-8 md:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10 lg:px-16 lg:py-9">
